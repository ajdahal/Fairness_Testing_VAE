...
def t_way_multivariate_combinations(synthesizer, ht, embedding_dim, multivariate_filename, filename_latent_representation, filename_labels, label_column_name):
        ...
        df_without_class = df_data.drop('class', axis=1) if 'class' in df_data.columns else df
        ...
        df_multivariate_without_class = df_multivariate.drop('class', axis=1) if 'class' in df_multivariate.columns else df_multivariate
