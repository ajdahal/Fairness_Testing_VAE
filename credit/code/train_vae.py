...
def train_vae(X_train_transformed, embedding_dim, output_dir):
    ...
    model_save_path = os.path.join(output_dir, f'{embedding_dim}_tvae_credit_synthesizer_model_{current_timestamp}.pkl')
    synthesizer.save(model_save_path)
    
    loss_save_path = os.path.join(output_dir, f'{embedding_dim}_tvae_credit_synthesizer_model_loss_summary_metrics_{current_timestamp}.csv')
