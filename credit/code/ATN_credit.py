...
def get_atn(test_data_file, adv_data_file, mode):
    ...
    continuous_cols = ['Attribute2', 'Attribute5', 'Attribute8', 'Attribute11', 'Attribute13', 'Attribute16', 'Attribute18']
    categorical_cols = ['Attribute1', 'Attribute3', 'Attribute4', 'Attribute6', 'Attribute7', 'Attribute9', 'Attribute10', 'Attribute12', 'Attribute14', 'Attribute15', 'Attribute17', 'Attribute19', 'Attribute20']       # class is removed
    
    # Call function to convert boolean columns (like 'class') to categorical
    # df_xs = convert_boolean_to_categorical(df_xs, ['class'])
    # df_xt = convert_boolean_to_categorical(df_xt, ['class'])
