...
def t_way_multivariate_combinations(synthesizer, ht, embedding_dim, multivariate_filename, filename_latent_representation, filename_labels, label_column_name):
        ...
        max_t = 6                                              # Change this hyperparameter - number of t_way combinations to form as necessary
        ...
        df_without_class = df_data.drop('two_year_recid', axis=1) if 'two_year_recid' in df_data.columns else df
        ...
        df_multivariate_without_class = df_multivariate.drop('two_year_recid', axis=1) if 'two_year_recid' in df_multivariate.columns else df_multivariate
