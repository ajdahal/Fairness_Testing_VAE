...
if __name__ =="__main__":
    ...
    best_embedding_dim, min_avg_loss_last_epoch = find_best_embedding_and_plot(models_folder)
    print(f"\n best_embedding_dim: {best_embedding_dim}, min_avg_loss_last_epoch: {min_avg_loss_last_epoch}")